  ...
  render(){
    return (
      <div className={styles.container}>
        <div className={styles['section-scrolling-anchor']} ref={this.section0}></div>
        <Head>
          <title>Artom</title>
        ...
        <section className={`${styles['section']} ${styles['about-us']}`}>
          ...
          <div className={styles['about-us-content-container']}>
            <div className={styles['about-us-title-and-text-container']}>
              <h1 className={`${styles['section-title']} ${styles['about-us-title']}`} >A DIVERSIFIED<br/>PORTFOLIO</h1>
              <p>
